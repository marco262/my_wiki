...
* [Wilhelm Scream]($load|effect|requests/wilhelmscream.mp3)
...
* [🍆 Arin Loves Penis]($load|effect|requests/Game Grumps - Arin Loves Penis Sbassbear Remix.mp3)
* [🍆 Arin Loves Penis (short)]($load|effect|requests/arin_loves_penis_short.mp3)
