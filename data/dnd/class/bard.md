...
# Core Bard Traits
 ...
 - **Starting Equipment**: _Choose A or B:_ (A) [[tooltip:Leather Armor]], 2 [[tooltip:dagger|Daggers]], Musical Instrument of your choice, [[tooltip:Entertainer's Pack]], and 19 GP; or (B) 90 GP
...
Once within the next hour when the creature fails a [[glossary:D20 Test]], the creature can roll the Bardic Inspiration die and add the number rolled to the d20, potentially turning the failure into a success. A Bardic Inspiration die is expended when it's rolled.
...
For example, if you make a Strength ([[tooltip:Athletics]]) check and lack [[tooltip:Athletics]] proficiency, you can add half your Proficiency Bonus to the check.
...
You can use musical notes or words of power to disrupt mind-influencing effects. If you or a creature within 30 feet of you fails a saving throw against an effect that applies the [[glossary:Charmed]] or [[glossary:Frightened]] condition, you can take a Reaction to cause the save to be rerolled, and the new roll has Advantage.
