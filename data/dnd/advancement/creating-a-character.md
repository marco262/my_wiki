...
2. **_Determine Origin._** A character's origin includes two elements: background and race. How did the character spend the years leading up to a life of adventure? Who are the character's ancestors? You can also choose your character's languages.
3. **_Determine Ability Scores._** Much of what your character does in the game depends on the character's six abilities.
4. **_Choose an Alignment._** Alignment is a shorthand for your character's moral compass.
5. **_Fill in Details._** Using the choices you've made, fill in the remaining details on your character sheet.
...
|-----------------------|----------------|-----------------------|------------|
| [[[class:Barbarian]]] | Battle         | Strength              | Average    |
| [[[class:Bard]]]      | Performing     | Charisma              | High       |
| [[[class:Cleric]]]    | Gods           | Wisdom                | Average    |
| [[[class:Druid]]]     | Nature         | Wisdom                | High       |
| [[[class:Fighter]]]   | Weapons        | Strength or Dexterity | Low        |
| [[[class:Monk]]]      | Unarmed combat | Dexterity and Wisdom  | High       |
| [[[class:Paladin]]]   | Defense        | Strength and Charisma | Average    |
| [[[class:Ranger]]]    | Survival       | Dexterity and Wisdom  | Average    |
| [[[class:Rogue]]]     | Stealth        | Dexterity             | Low        |
| [[[class:Sorcerer]]]  | Power          | Charisma              | High       |
...
Write your character's level on your character sheet. Typically, a character starts at level 1 and advances in level by adventuring and gaining [[glossary:Experience Points]] (XP).
...
You'll fill in more details about your class later. Choosing your class is the most important decision you make in creating a character, and it informs many of the decisions you make in later steps. You'll return to your class's description several more times before you're done.
...
Your class also gives proficiencies. Check your class description and note the proficiencies on your character sheet.
...
Let your character's background and race inspire how you imagine their past. That past fed into the character's present. With that in mind, consider answers to the following questions as your character:
...
To determine your character's ability scores, you first generate a set of six numbers using the instructions below and then assign them to your six abilities. [[[general:Playing the Game#the-six-abilities|Playing the Game]]] explains what each ability means.
...
**_Cleric:_** Replace with Bard or Druid

**_Fighter:_** Replace with Barbarian, Monk, Paladin, or Ranger

**_Rogue:_** Replace with Bard or Ranger
...
| Chaotic   | 1   | Boastful         |
| Chaotic   | 2   | Impulsive        |
| Chaotic   | 3   | Rebellious       |
| Chaotic   | 4   | Self-absorbed    |
...
Look at your class's features table, and write down the level 1 features. The class features are detailed on that same page.
...
**_Passive Perception._** Sometimes your DM will determine whether your character notices something without asking you to make a Wisdom ([[tooltip:Perception]]) check; the DM uses your Passive Perception instead. Passive Perception is a score that reflects a general awareness of your surroundings when you're not actively looking for something. Use this formula to determine your Passive Perception score:

* **_Passive Perception_** = 10 + Wisdom ([[tooltip:Perception]]) check modifier</p>

Include all modifiers that apply to your Wisdom ([[tooltip:Perception]]) checks. For example, if your character has a Wisdom of 15 and proficiency in the [[tooltip:Perception]] skill, you have a Passive Perception of 14 (10 + 2 for your Wisdom modifier + 2 for proficiency).
...
The character sheet includes room to note your current Hit Points when you take damage, as well as any [[glossary:Temporary Hit Points]] you might gain. There's also space to track [[glossary:Death Saving Throws|Death Saving Throws]].
...
* **_Spell save DC_** = 8 + spellcasting ability modifier + Proficiency Bonus
* **_Spell attack bonus_** = spellcasting ability modifier + Proficiency Bonus
...
While going on adventures, your character gains experience, represented by [[glossary:Experience Points]] (XP). A character who reaches a specified Experience Point total advances in capability. This advancement is called gaining a level.
...
When you gain your first level in a class other than your initial class, you gain only some of the new class's starting proficiencies, as detailed in each class's description.
...
If you have multiple ways to calculate your [[glossary:Armor Class]], you can benefit from only one at a time. For example, a Monk/Sorcerer with a Monk's Unarmored Defense feature and a Sorcerer's Draconic Resilience feature must choose only one of those features as a way to calculate Armor Class.
...
| 49    | A silver spoon with an <em>M</em> engraved on the handle                                                                |
