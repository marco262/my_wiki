...
<table border=1>
    <tr valign="top">
        ...
        % for c in classes:
            <input type="checkbox" name="checkbox-class" id="{{c}}" checked>{{c.title()}} Spells<br>
        % end
        </td>
        <td>
        ...
        % for l in levels:
            <input type="checkbox" name="checkbox-level" id="{{l}}" checked>{{ordinal(l)}}<br>
        % end
        </td>
        <td>
        ...
        % for s in schools:
            <input type="checkbox" name="checkbox-school" id="{{s}}" checked>{{s.title()}}<br>
        % end
        </td>
        <td>
            <table>
