...
| Level | Prof.<br>Bonus |         Class Features         | Cantrips | 1st | 2nd | 3rd | 4th | 5th | 6th | 7th | 8th | 9th |
|:-----:|:--------------:|:------------------------------:|:--------:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
...
You have learned to cast Spells through prayer, meditation, and devotion. See the _Player's Handbook_ for the rules on spellcasting. The information below details how you use those rules as a Cleric.

***Prepared Spells.*** You have the following Spells prepared: _[Cure Wounds](/onednd/spell/Cure Wounds)_, _[Sacred Flame](/onednd/spell/Sacred Flame)_, _[Shield of Faith](/onednd/spell/Shield of Faith)_, _[Spare the Dying](/onednd/spell/Spare the Dying)_, and _[Thaumaturgy](/onednd/spell/Thaumaturgy)_. Alternatively, you can prepare three 0-level Spells (also known as cantrips) and two 1st-level Spells of your choice. Any Spell you prepare for this Class must be a [Divine](/onednd/general/Spellcasting Rules#divine-spells) Spell.
...
* **Thaumaturge.** Delving deeper into your divine magical abilities, you can prepare one extra 0-level Spell from the [Divine Spell list](/onednd/general/Spellcasting Rules#divine-spells). See your Spellcasting feature for more information on preparing Spells. In addition, you regain one expended use of your Channel Divinity whenever you finish a Short Rest.

### 3rd Level: Cleric Subclass

You gain the [Life Domain](/onednd/subclass/Life Domain) Subclass or another Cleric Subclass of your choice. The Life Domain is detailed after the Cleric's Class description, and other Subclasses will appear in future _Unearthed Arcana_ articles.
