...
**Skill Proficiencies.** Choose two [Skills](/dnd/general/Using Ability Scores#skills). Your character gains Proficiency in them.  
**Tool Proficiency.** Choose one [[[general:equipment#tools|Tool]]]. Your character gains Tool Proficiency with it.  
**Language.** Choose one language from the [Standard Languages](#standard-languages) or [Rare Languages](#rare-languages) tables. Your character knows that language.  
**Feat.** Choose one 1st-level [[[advancement:feats|Feat]]]. Your character gains that Feat.  
**Equipment.** Your character gains 50 GP to spend on starting [[[general:equipment]]]. The character keeps any unspent GP as spare coin.
...
The sample backgrounds that provide the Magic Initiate feat have been changed from their form in the playtest document to instead provide access to a specific class' spell list. This change was made because the latest playtest documents appear to be moving away from the Arcane/Divine/Primal spells lists and back to class-specific spell lists. 
...
**Language:** Abyssal  
**Feat:** [[[advancement:feats#magic-initiate|Magic Initiate]]] (Warlock)
...
**Language:** Giant  
**Feat:** [[[advancement:feats#magic-initiate|Magic Initiate]]] (Ranger)
...
<sup>* Includes the Aquan, Auran, Ignan, and Terran dialects</sup>
