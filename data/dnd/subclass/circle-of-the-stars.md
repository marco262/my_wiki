...
While holding the map, you have the _[[[spell:Guidance]]]_ and _[[[spell:Guiding Bolt]]]_ spells prepared, and you can cast _Guiding Bolt_ without expending a spell slot. You can cast it in that way a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [[glossary:Long Rest]].
...
While in your starry form, you retain your game statistics, but your body becomes luminous, your joints glimmer like stars, and glowing lines connect them as on a star chart. This form sheds [[glossary:Bright Light]] in a 10-foot radius and [[glossary:Dim Light]] for an additional 10 feet. The form lasts for 10 minutes. It ends early if you dismiss it (no action required), have the [[glossary:Incapacitated]] condition, or use this feature again.
...
**_Dragon._** A constellation of a wise dragon appears on you. When you make an Intelligence or a Wisdom check or a Constitution saving throw to maintain [[glossary:Concentration]], you can treat a roll of 9 or lower on the d20 as a 10.

### Level 6: Cosmic Omen

Whenever you finish a [[glossary:Long Rest]], you can consult your Star Map for omens and roll a die. Until you finish your next Long Rest, you gain access to a special Reaction based on whether you rolled an even or an odd number on the die:

**_Weal (Even)._** Whenever a creature you can see within 30 feet of you is about to make a [[glossary:D20 Test]], you can take a Reaction to roll 1d6 and add the number rolled to the total.
...
_Source: Player's Handbook, p. 88_
