...
# Core Warlock Traits
 ...
 - **Skill Proficiencies**: _Choose 2:_ [[tooltip:Arcana]], [[tooltip:Deception]], [[tooltip:History]], [[tooltip:Intimidation]], [[tooltip:Investigation]], [[tooltip:Nature]], or [[tooltip:Religion]]
 - **Weapon Proficiencies**: Simple weapons
 - **Armor Training**: Light armor
 - **Starting Equipment**: _Choose A or B:_ (A) [[tooltip:Leather Armor]], [[tooltip:Sickle]], 2 [[tooltip:dagger|Daggers]], [[tooltip:Arcane Focus]] (orb), Book (occult lore), [[tooltip:Scholar's Pack]], and 15 GP; or (B) 100 GP
...
Once per turn when you hit a creature with your pact weapon, you can expend a Pact Magic spell slot to deal an extra 1d8 Force damage to the target, plus another 1d8 per level of the spell slot, and you can give the target the [[glossary:Prone]] condition if it is Huge or smaller.
...
**_Quick Attack._** As a Bonus Action, you can command the familiar to take the [[glossary:Attack]] action.
...
You gain the Extra Attack feature for your pact weapon only. With that feature, you can attack twice with the weapon instead of once when you take the [[glossary:Attack]] action on your turn.
...
_Source: Player's Handbook, p. 153_
