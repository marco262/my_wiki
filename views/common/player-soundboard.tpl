...
<p>
    <button id="custom_music_button">Music</button>
...
* [🖕 Fuck Ya Life, Bing Bong]($load|effect|requests/fuck_ya_life_bing_bong.ogg)
* [⚖️ Law & Order]($load|effect|requests/law_and_order.mp3)
* [🙅 The Next Time You Think You're a Failure...]($load|effect|requests/think_youre_a_failure.mp3)
* [😂 You're A Menace! I Hate You!]($load|effect|requests/youre_a_menace_i_hate_you.ogg)
* [♫ Fucking Bullshit ♫]($load|effect|requests/fucking_bullshit.ogg)
* [🐿️ Alan! Alan! Alan!]($load|effect|requests/alan_alan_alan.ogg)
* [♫ Mission Impossible ♫]($load|effect|requests/mission_impossible.ogg)
* [🙇 Please Don't Kill Us! (long)]($load|effect|requests/it_wasnt_my_fault.ogg)
...
* [🎬 Last Time On Game Grumps]($load|effect|requests/last_time_on_game_grumps.mp3)
* [🦔 Sonic Heroes NOOOOOOOOO!]($load|effect|requests/sonic_heroes_nooooo.mp3)
* [💀 Doo Doo-Doo Doo Doo Doo Kill Your Parents]($load|effect|requests/kill_your_parents.mp3)
* [👐 Get Bigger Hands!]($load|effect|requests/get_bigger_hands.mp3)
* [🔪 Don't Fucking Jump at Me, You Piece of Shit! I'll Fucking Stab Your Parents!]($load|effect|requests/ill_fucking_stab_your_parents.mp3)
...
* [😂 Yeah, Baby! Shit, I Missed!]($load|effect|requests/yeah_baby_shit_i_missed.ogg)

### Music

* [Love Pony Mashup]($load|music|requests/dj_cummerbund.ogg)
...
* [Science Adjacent with Evan and Katelyn, Yeah!]($load|effect|requests/science_adjacent.mp3)
* [Resin Time]($load|effect|requests/resin_time.mp3)
* [Who's That Pokémon?]($load|effect|requests/whos_that_pokemon.mp3)
* [Mmm, Whatcha Say?]($load|effect|requests/mmm_whatcha_say.mp3)

### Ambience

* [1 hour of silence occasionally broken by the first 4 notes of Megalovania]($load|ambience|1 hour of silence occasionally broken by the first 4 notes of Megalovania.ogg)
...
* [Goofy Scream]($load|effect|requests/goofy_yell.mp3)
...
* [🚨 Kill Bill Siren]($load|effect|requests/Kill Bill Ironside Siren Sound.mp3)
...
* [Fuck This Shit I'm Out]($load|effect|requests/fuck-this-shit-im-out.mp3)
* [I Just Did A Bad Thing]($load|effect|requests/i just did a bad thing.mp3)
...
* [Star Drunk - Pew Pew Pew!]($load|effect|requests/pew_pew_pew.mp3)
* [✋ Talkin' Smachck]($load|effect|requests/talkin_smachck.mp3)
* [🇬🇧 I Might Have Made An Error]($load|effect|requests/i_might_have_made_an_error.mp3)
* [🎸 Here Come The Consequences!]($load|effect|requests/here_come_the_consequences.mp3)
* [😈 Mine Is An Evil Laugh]($load|effect|requests/mine_is_an_evil_laugh.mp3)
* [Curse Your Sudden But Inevitable Betrayal]($load|effect|requests/curse_your_sudden_but_inevitable_betrayal.mp3)
* [⚗️Kuzco's Poison]($load|effect|requests/kuzcos_poison.mp3)
* [🛑 I Thought Someone Was Gonna Stop Me]($load|effect|requests/i_thought_someone_was_gonna_stop_me.mp3)
* [😭 STOP YELLING AT ME]($load|effect|requests/STOP_YELLING_AT_ME.mp3)
...
<script type="module">
    import { init_links, init_soundboard, set_player_soundboard } from "/static/js/common/visual_aid_backend.js";
    init_links();
    init_soundboard();
