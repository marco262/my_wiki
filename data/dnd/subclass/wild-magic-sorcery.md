...
| 17–20 | You are subjected to an effect that lasts for 1 minute unless its description says otherwise. Roll 1d8 to determine the effect: on a **1**, you're surrounded by faint, ethereal music only you and creatures within 5 feet of you can hear; on a **2**, your size increases by one size category; on a **3**, you grow a long beard made of feathers that remains until you sneeze, at which point the feathers explode from your face and vanish; on a **4**, you must shout when you speak; on a **5**, illusory butterflies flutter in the air within 10 feet of you; on a **6**, an eye appears on your forehead, granting you [[glossary:Advantage]] on Wisdom ([[tooltip:Perception]]) checks; on an **7**, pink bubbles float out of your mouth whenever you speak; on an **8**, your skin turns a vibrant shade of blue for 24 hours or until the effect is ended by a [[[spell:Remove Curse]]] spell. |
...
| 49–52 | A spectral shield hovers near you for the next minute, granting you a +2 bonus to AC and immunity to [[[spell:Magic Missile]]]. |
| 53–56 | You can take one extra action on this turn. |
| 57–60 | You cast a random spell. If the spell normally requires [[glossary:Concentration]], it doesn't require Concentration in this case; the spell lasts for its full duration. Roll 1d10 to determine the spell: on a **1**, [[[spell:Confusion]]]; on a **2**, [[[spell:Fireball]]]; on a **3**, [[[spell:Fog Cloud]]]; on a **4**, [[[spell:Fly]]] (cast on a random creature within 60 feet of you), on a **5**, [[[spell:Grease]]]; on a **6**, [[[spell:Levitate]]] (cast on yourself); on a **7**, [[[spell:Magic Missile]]] (cast as a level 5 spell); on an **8**, [[[spell:Mirror Image]]]; on a **9**, [[[spell:Polymorph]]] (cast on yourself), and if you fail the saving throw, you turn into a [[[monster:Goat]]]; on a **10**, [[[spell:See Invisibility]]]. |
...
| 65–68 | If you die within the next hour, you immediately revive as if by the [[[spell:Reincarnate]]] spell. |
