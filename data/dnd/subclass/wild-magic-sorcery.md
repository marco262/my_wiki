...
| 05–08 | A creature that is [[glossary:Friendly]] toward you appears in a random unoccupied space within 60 feet of you. The creature is under the DM's control and disappears 1 minute later. Roll 1d4 to determine the creature: on a **1**, a [[[monster:Modron Duodrone]]] appears; on a **2**, a [[[monster:Flumph]]] appears; on a **3**, a [[[monster:Modron Monodrone]]] appears; on a **4**, a [[[monster:Unicorn]]] appears. See the _Monster Manual_ for the creature's stat block. |
| 09–12 | For the next minute, you regain 5 Hit Points at the start of each of your turns. |
| 13–16 | Creatures have [[glossary:Disadvantage]] on saving throws against the next spell you cast in the next minute that involves a saving throw. |
| 17–20 | You are subjected to an effect that lasts for 1 minute unless its description says otherwise. Roll 1d8 to determine the effect: on a **1**, you're surrounded by faint, ethereal music only you and creatures within 5 feet of you can hear; on a **2**, your size increases by one size category; on a **3**, you grow a long beard made of feathers that remains until you sneeze, at which point the feathers explode from your face and vanish; on a **4**, you must shout when you speak; on a **5**, illusory butterflies flutter in the air within 10 feet of you; on a **6**, an eye appears on your forehead, granting you [[glossary:Advantage]] on Wisdom ([[tooltip:Perception]]) checks; on an **7**, pink bubbles float out of your mouth whenever you speak; on an **8**, your skin turns a vibrant shade of blue for 24 hours or until the effect is ended by a _[[[spell:Remove Curse]]]_ spell. |
...
| 37–40 | You turn into a potted plant until the start of your next turn. While you're a plant, you have the [[glossary:Incapacitated]] condition and have Vulnerability to all damage. If you drop to 0 Hit Points, your pot breaks, and your form reverts. |
| 41–44 | For the next minute, you can teleport up to 20 feet as a Bonus Action on each of your turns. |
| 45–48 | You and up to three creatures you choose within 30 feet of you have the [[glossary:Invisible]] condition for 1 minute. This invisibility ends on a creature immediately after it makes an attack roll, deals damage, or casts a spell. |
| 49–52 | A spectral shield hovers near you for the next minute, granting you a +2 bonus to AC and immunity to _[[[spell:Magic Missile]]]_. |
| 53–56 | You can take one extra action on this turn. |
| 57–60 | You cast a random spell. If the spell normally requires [[glossary:Concentration]], it doesn't require Concentration in this case; the spell lasts for its full duration. Roll 1d10 to determine the spell: on a **1**, _[[[spell:Confusion]]]_; on a **2**, _[[[spell:Fireball]]]_; on a **3**, _[[[spell:Fog Cloud]]]_; on a **4**, _[[[spell:Fly]]]_ (cast on a random creature within 60 feet of you), on a **5**, _[[[spell:Grease]]]_; on a **6**, _[[[spell:Levitate]]]_ (cast on yourself); on a **7**, _[[[spell:Magic Missile]]]_ (cast as a level 5 spell); on an **8**, _[[[spell:Mirror Image]]]_; on a **9**, _[[[spell:Polymorph]]]_ (cast on yourself), and if you fail the saving throw, you turn into a [[[monster:Goat]]]; on a **10**, _[[[spell:See Invisibility]]]_. |
| 61–64 | For the next minute, any flammable, nonmagical object you touch that isn't being worn or carried by another creature bursts into flame, takes 1d4 Fire damage, and is [[glossary:burning]]. |
| 65–68 | If you die within the next hour, you immediately revive as if by the _[[[spell:Reincarnate]]]_ spell. |
| 69–72 | You have the [[glossary:Frightened]] condition until the end of your next turn. The DM determines the source of your fear. |
| 73–76 | You teleport up to 60 feet to an unoccupied space you can see. |
| 77–80 | A random creature within 60 feet of you has the [[glossary:Poisoned]] condition for 1d4 hours. |
| 81–84 | You radiate [[glossary:Bright Light]] in a 30-foot radius for the next minute. Any creature that ends its turn within 5 feet of you has the [[glossary:Blinded]] condition until the end of its next turn. |
...
You can manipulate chaos itself to give yourself [[glossary:Advantage]] on one [[glossary:D20 Test]] before you roll the d20. Once you do so, you must cast a Sorcerer spell with a spell slot or finish a [[glossary:Long Rest]] before you can use this feature again.
...
You have the ability to twist fate using your wild magic. Immediately after another creature you can see rolls the d20 for a [[glossary:D20 Test]], you can take a Reaction and spend 1 Sorcery Point to roll 1d4 and apply the number rolled as a bonus or penalty (your choice) to the d20 roll.
...
_Source: Player's Handbook, p. 149_
