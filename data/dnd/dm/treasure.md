...
The most basic type of treasure is money, including Copper Pieces (CP), Silver Pieces (SP), Electrum Pieces (EP), Gold Pieces (GP), and Platinum Pieces (PP). See [[[general:Equipment#Coin Values]]] for their relative value. Fifty coins of any type weigh 1 pound.
...
**_Paired Items._** You can allow exceptions to the rule that paired items must both be worn. For example, a character with only one arm might be able to use a single [[tooltip:Glove of Missile Snaring]] so long as the matching glove is on their person.
...
| Category            | Examples                                                   |
|---------------------|------------------------------------------------------------|
| [Armor](#)          | [[tooltip:+1 Leather Armor]], [[tooltip:+1 Shield]]        |
| [Potions](#)        | [[tooltip:Potion of Healing]]                              |
| [Rings](#)          | [[tooltip:Ring of Invisibility]]                           |
| [Rods](#)           | [[tooltip:Immovable Rod]]                                  |
| [Scrolls](#)        | [[tooltip:Spell Scroll]]                                   |
| [Staffs](#)         | [[tooltip:Staff of Striking]]                              |
| [Wands](#)          | [[tooltip:Wand of Fireballs]]                              |
| [Weapons](#)        | [[tooltip:+1 Ammunition]], [[tooltip:+1 Longsword]]        |
| [Wondrous Items](#) | [[tooltip:Bag of Holding]], [[tooltip:Boots of Elvenkind]] |

### Armor

An item in the Armor category is typically a magical version of armor from [[[general:Equipment#Armor]]]. Unless an armor's description notes otherwise, the armor must be worn for its magic to function.

Some suits of magic armor specify the type of armor they are, such as [[tooltip:Chain Mail]] or [[tooltip:Plate Armor]]. If no type is specified, choose the type or determine it randomly.
...
| 1d100 | Result |
|---|---|
| 01 | Both potions lose their effects, and the mixture creates a magical explosion in a 5-foot-radius [[glossary:Sphere]] centered on itself. Each creature in that area takes 4d10 Force damage. |
| 02–08 | Both potions lose their effects, and the mixture becomes an ingested poison of your choice (see [[[dm:DM's Toolbox#Poison]]]). |
...
| 00 | Only one potion works, but its effects are permanent. Choose the simplest effect to make permanent or the one that seems the most fun. For example, a [[tooltip:Potion of Healing]] might increase the drinker's Hit Point maximum by 2d4 + 2, or a [[tooltip:Potion of Invisibility]] might give the drinker the [[glossary:Invisible]] condition indefinitely. At your discretion, a [[[spell:Dispel Magic]]] spell or similar magic might end this lasting effect. |
...
Unless its description notes otherwise, a rod can be used as an [[tooltip:Arcane Focus]].

### Scrolls

An item in the Scroll category is a roll of paper or parchment, sometimes attached to wooden rods and typically kept safe in a tube of ivory, jade, leather, metal, or wood. The most prevalent scroll is the [[tooltip:Spell Scroll]], a spell stored in written form. However, some scrolls, like the [[tooltip:Scroll of Protection]], bear an incantation that isn't a spell.
...
Unless its description notes otherwise, a staff can be used as a nonmagical [[tooltip:Quarterstaff]] and an [[tooltip:Arcane Focus]].
...
Unless its description notes otherwise, a wand can be used as an [[tooltip:Arcane Focus]].

### Weapons

A magic weapon is typically a magical version of a weapon from the Weapons section in [[[general:equipment#Weapons|Equipment]]]. Some magic weapons specify the type of weapon they are in their descriptions, such as a [[tooltip:Longsword]] or [[tooltip:Longbow]]. If no weapon type is specified, you may choose the type or determine it randomly.

**_Ammunition._** If a magic weapon has the [[tooltip:Ammunition]] property, ammunition fired from it is considered magical for the purpose of any rule that cares whether a weapon is magical or not.
...
Common magic items, such as a [[tooltip:Potion of Healing]], are the most plentiful. Artifacts, such as the [[tooltip:Wand of Orcus]], are priceless, unique, and difficult to acquire.

### Magic Item Values by Rarity

Common magic items can often be bought in a town or city. Uncommon and Rare magic items are usually found only in cities, and rarer magic items might be sold only in wondrous locations, such as the [[tooltip:City of Brass]] or [[tooltip:Sigil]]. If you allow characters to buy and sell magic items in your campaign, rarity can help you set prices for those items. Gold Piece values are provided in the Magic Item Rarities and Values table, though a seller might ask for a service rather than coin as payment.

If a magic item incorporates an item that has a purchase cost in [[[general:Equipment]]] (such as a weapon or a suit of armor), add that item's cost to the magic item's value. For example, [[tooltip:+1 Armor (Plate Armor)]] has a value of 5,500 GP, which is the sum of a Rare magic item's value (4,000 GP) and the cost of [[tooltip:Plate Armor]] (1,500 GP).
...
D&D Beyond has a Magic Item Tracker sheet as a [downloadable PDF](https://media.dndbeyond.com/compendium-images/free-rules/dmg/magic-item-sheet.pdf).
...
If you're starting a campaign for characters above level 1, [[[advancement:Creating a Character#Starting Equipment at Higher Levels]]] offers suggestions for how many magic items such characters should start with and the rarity of those items. Consider these approaches to determining the items each character receives:
...
Some items are consumed -- used up, in other words -- when they are activated. A [[tooltip:Potion of Healing]] must be swallowed, for example, while the writing vanishes from a scroll when it is read. Once used, a consumable item loses its magic.

### Spells Cast from Items

Some magic items allow the user to cast a spell from the item. The spell is cast at the lowest possible spell and caster level, doesn't expend any of the user's spell slots, and requires no components unless the item's description notes otherwise. The spell uses its normal casting time, range, and duration, and the user of the item must concentrate if the spell requires [[glossary:Concentration]]. Many items, such as Potions, bypass the casting of a spell and confer the spell's effects with its usual duration. Certain items make exceptions to these rules, changing the casting time, duration, or other parts of a spell.
...
A magic item's description specifies whether it bears a curse. Most methods of identifying items, including the [[[spell:Identify]]] spell, fail to reveal such a curse.

Attunement to a cursed item can't be ended voluntarily unless the curse is broken first, such as with a [[[spell:Remove Curse]]] spell.
...
[[[general:Equipment]]] contains rules on [[[general:Equipment#Brewing Potions of Healing]]] and [[[general:Equipment#Scribing Spell Scrolls]]]. To create other magic items, follow the rules below. In these rules, "you" refers to the character crafting the magic item.

### Arcana Proficiency

To craft a magic item, you and any assistants must have proficiency in the [[tooltip:Arcana]] skill.

### Tools

The Magic Item Tools table lists which tool is required to make a magic item of each category. You must use the required tool to make an item and have proficiency with that tool. Any assistants must also have proficiency with it. For more information on the tools, see [[[general:Equipment#Tools]]].

#### Magic Item Tools

| Item Category | Required Tool |
|---|---|
| Armor | [[tooltip:Leatherworker's Tools]], [[tooltip:Smith's Tools]], or [[tooltip:Weaver's Tools]] depending on the kind of armor as noted in the tools' descriptions |
| Potion | [[tooltip:Alchemist's Supplies]] or [[tooltip:Herbalism Kit]] |
| Ring | [[tooltip:Jeweler's Tools]] |
| Rod | [[tooltip:Woodcarver's Tools]] |
| Scroll | [[tooltip:Calligrapher's Supplies]] |
| Staff | [[tooltip:Woodcarver's Tools]] |
| Wand | [[tooltip:Woodcarver's Tools]] |
| Weapon | [[tooltip:Leatherworker's Tools]], [[tooltip:Smith's Tools]], or [[tooltip:Woodcarver's Tools]] depending on the kind of weapon as noted in the tools' descriptions |
| Wondrous Item | [[tooltip:Tinker's Tools]] or the tool required to make the nonmagical item on which the magic item is based |
...
If a magic item incorporates an item that has a purchase cost (such as a weapon or a suit of armor), you must also pay that entire cost or craft that item using the [[[general:Equipment#Crafting Equipment]]] rules. For example, to make [[tooltip:+1 Armor (Plate Armor)]], you must pay 3,500 GP or pay 2,000 GP and craft the armor.
...
| 13 | **Fey.** The item is exquisitely crafted from the finest materials and glows with a pale radiance in moonlight, shedding [[glossary:Dim Light]] in a 5-foot radius. Any metal in the item is silver or mithral rather than iron or steel. |
...
| 1d20 | Minor Property |
|---|---|
| 1–2 | **Beacon.** You can take a Bonus Action to cause the item to shed [[glossary:Bright Light]] in a 10-foot radius and [[glossary:Dim Light]] for an additional 10 feet, or to extinguish the light. |
| 3 | **Compass.** You can take a [[glossary:Magic]] action to learn which way is magnetic north. Nothing happens if this property is used in a location that has no magnetic north. |
...
| 5–6 | **Guardian.** The item warns you, granting a +2 bonus to your [[glossary:Initiative]] rolls if you don't have the [[glossary:Incapacitated]] condition. |
...
| 18 | **War Leader.** You can take a [[glossary:Magic]] action to cause your voice or signal to carry clearly for up to 600 feet until the end of your next turn. |
| 19 | **Waterborne.** This item floats on water and other liquids. You have [[glossary:Advantage]] on Strength ([[tooltip:Athletics]]) checks to swim. |
...
| 21–30 | While attuned to the Artifact, you have Immunity to the [[glossary:Poisoned]] condition. |
| 31–40 | While attuned to the Artifact, you have Immunity to the [[glossary:Charmed]] and [[glossary:Frightened]] conditions. |
...
| 91–00 | While attuned to the Artifact, you have Immunity to the [[glossary:Blinded]], [[glossary:Deafened]], [[glossary:Petrified]], and [[glossary:Stunned]] conditions. |
...
| 25–32 | While attuned to the Artifact, you have the [[glossary:Blinded]] condition when you're more than 10 feet away from it. |
| 33–40 | While attuned to the Artifact, you have the [[glossary:Deafened]] condition when you're more than 10 feet away from it. |
...
| 77–80 | While you're attuned to the Artifact, all [[tooltip:Holy Water]] within 10 feet of you is destroyed. |
...
| 93–00 | While you're attuned to the Artifact, Beasts within 30 feet of you that have a Challenge Rating of 6 or lower are [[glossary:Hostile]] toward you. |
...
| 10–18 | When you become attuned to the Artifact, a random one of your ability scores is reduced by 2, to a minimum of 3. A [[[spell:Greater Restoration]]] spell restores the ability. |
...
| 37–45 | Each time you become attuned to the Artifact, there is a 10 percent chance that you attract the attention of a god who sends an avatar to wrest the Artifact from you. The avatar has the same alignment as its creator and uses the [[[monster:Empyrean]]] stat block. Once it obtains the Artifact, the avatar vanishes. |
| 46–54 | Each time you become attuned to the Artifact, you must succeed on a DC 10 Constitution saving throw or die from the shock. If you die, you're instantly transformed into a [[[monster:Wight]]] under the DM's control that must protect the Artifact. |
...
| 73–81 | While you're attuned to the Artifact, creatures of a particular type other than Humanoid (chosen by the DM) are always [[glossary:Hostile]] toward you. |
| 82–90 | While attuned to the Artifact, you have Vulnerability to all damage. |
| 91–96 | The Artifact imprisons a [[[monster:Death Slaad]]]. Each time you become attuned to the Artifact, the slaad has a 10 percent chance of escaping, whereupon it appears in an unoccupied space as close to you as possible and attacks you. |
...
The DM controls sentient magic items and their activated properties. A bearer who maintains a good relationship with the item can access those properties. If the relationship is strained, a conflict can ensue (see [Conflict](#)).

### Sentient Magic Item Traits

When you make a sentient magic item, you create the item's persona much as you would create an NPC (as described in [[[dm:DM's Toolbox#Nonplayer Characters]]]), with these exceptions.
...
**_Special Purpose._** You can give a sentient item an objective it pursues, perhaps to the exclusion of all else. As long as the wielder's use of the item aligns with that special purpose, the item remains cooperative. Deviating from this course might cause conflict between the wielder and the item (see [Conflict](#)). You can pick a special purpose or roll on the Sentient Item's Special Purpose table.
...
| 4   | Hearing and [[glossary:Darkvision]] out to 120 feet |
