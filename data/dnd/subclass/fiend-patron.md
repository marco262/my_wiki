[[breadcrumb /dnd/class/Warlock|Warlock]]
...
When you reduce an enemy to 0 Hit Points, you gain [[glossary:Temporary Hit Points]] equal to your Charisma modifier plus your Warlock level (minimum of 1 Temporary Hit Point). You also gain this benefit if someone else reduces an enemy within 10 feet of you to 0 Hit Points.
...
You can use this feature a number of times equal to your Charisma modifier (minimum of once), but you can use it no more than once per roll. You regain all expended uses when you finish a [[glossary:Long Rest]].

### Level 10: Fiendish Resilience

Choose one damage type, other than Force, whenever you finish a [[glossary:Short Rest|Short]] or [[glossary:Long Rest]]. You have Resistance to that damage type until you choose a different one with this feature.
...
Once you use this feature, you can't use it again until you finish a [[glossary:Long Rest]] unless you expend a Pact Magic spell slot (no action required) to restore your use of it.

----

_Source: Player's Handbook, p. 161_
